...
public interface MidnightIronTool{
    ...
    default void addSharedAbilities( List<Component> components){
        ...
        Component midnightOilEffect=Component.translatable("tooltip.celestial_awakening.midnight_iron_gear.midnight_oil_effect").setStyle(Style.EMPTY.withBold(true).withColor(TextColor.fromRgb(nameColor)));
