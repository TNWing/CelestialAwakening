    ...
    public void executeAbility(LivingEntity target) {
        if (state==1){
            ...
            if (currentStateTimer==110){
                ...
                LunarCrescent crescent=new LunarCrescent(serverLevel,bigCrescentDmgVals[diffMod],270,1f,ang,0,0,8f,2f,1f,8f);
                ...
                LunarCrescent crescent=new LunarCrescent(serverLevel,smallCrescentDmgVals[diffMod],120,6f,ang,0,0,1f,0.25f,1f,1f);
                int id=crescent.getId();
                crescent.setPos(this.mob.position().add(dir.scale(0.2f)));
                crescent.setOwner(this.mob);
                serverLevel.addFreshEntity(crescent);
