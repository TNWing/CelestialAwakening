...
public class NightProwlerAnimations {
	...
	public static final AnimationDefinition leap = AnimationDefinition.Builder.withLength(0.8333F)
		.addAnimation("root", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("root", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, -2.7F, 1.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("lowerbody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition mathWalk = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("f_left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition walkOld = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("f_left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition leapEnd = AnimationDefinition.Builder.withLength(0.5F)
		.addAnimation("root", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
