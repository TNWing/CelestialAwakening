...
public class ModelLayerInit {
    public static final ModelLayerLocation ASTERON_LAYER =new ModelLayerLocation(
            CelestialAwakening.createResourceLocation("transcendent_asteron_layer"),"main");
    ...
    public static final ModelLayerLocation ASTRALITE_LAYER =new ModelLayerLocation(
            CelestialAwakening.createResourceLocation("transcendent_astralite_layer"),"main");
    public static final ModelLayerLocation NEBURE_LAYER =new ModelLayerLocation(
            CelestialAwakening.createResourceLocation("transcendent_nebure_layer"),"main");
